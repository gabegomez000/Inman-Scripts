...
def read_timestamp_INACTIVE():
    try:
        with open('timestamp_INACTIVE.txt', 'r') as file:
...
def write_timestamp_INACTIVE():
    current_timestamp = datetime.now().strftime('%Y-%m-%d')
    with open('timestamp_INACTIVE.txt', 'w') as file:
...
while True:
    ...
    excel_file_path = f'export-inman-inactive-{formatted_currdate}.xlsx'
